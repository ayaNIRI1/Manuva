...
export default function Dashboard() {
    ...
    const dashboardCardsData = [
        { title: 'Total Products', value: dashboardData.stats?.approved_products || 0, icon: ShoppingBasketIcon },
        { title: 'Total Earnings', value: currency + (dashboardData.stats?.total_revenue || 0), icon: CircleDollarSignIcon },
        { title: 'Total Orders', value: dashboardData.recent_orders?.length || 0, icon: TagsIcon },
