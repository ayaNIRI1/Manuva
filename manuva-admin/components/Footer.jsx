    ...
    const linkSections = [
        {
            title: "الأقسام",
            links: [
                { text: "الفخار", path: '/shop?category=pottery', icon: null },
                { text: "المنسوجات", path: '/shop?category=textiles', icon: null },
                { text: "النحاس", path: '/shop?category=copper', icon: null },
                { text: "الجلود", path: '/shop?category=leather', icon: null },
            ]
        },
        {
            title: "روابط مفيدة",
            links: [
                { text: "الرئيسية", path: '/', icon: null },
                { text: "سياسة الخصوصية", path: '/', icon: null },
                { text: "كن حرفيًا", path: '/create-store', icon: null },
                { text: "من نحن", path: '/', icon: null },
            ]
        },
        {
            title: "تواصل معنا",
            links: [
                { text: "contact@manuva.dz", path: 'mailto:contact@manuva.dz', icon: MailIcon },
                { text: "+213 555 123 456", path: 'tel:+213555123456', icon: PhoneIcon },
                { text: "عنابة، الجزائر", path: '/', icon: MapPinIcon }
            ]
        }
    ];
